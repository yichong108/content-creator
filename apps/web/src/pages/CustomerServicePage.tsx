 ...
 * 预设快捷测试场景标签。
 *
 * 问题与 scripts/seed_rag_documents.py 灌入的 4 份示例 FAQ 对齐：
 * 产品介绍与价格 / 发货与物流政策 / 退换货政策 / 使用教程。
 *
 * 场景覆盖：
 * - RAG 命中：👋你好 / 💰价格 / ⏱️开通时间 / 📦退款 / 🔧教程
 * - RAG 未命中：⚠️超范围 —— 订机票不在 SaaS 服务范围内
 * - 多轮追问：先问💰价格，再点🤔最低档 —— 验证 agent 能否记住上下文
 */
const QUICK_QUESTIONS: { label: string; text: string }[] = [
  { label: "👋 你好", text: "你好，请问你能帮我做什么？" },
  { label: "💰 价格多少", text: "你们的产品价格是怎么定的？" },
  { label: "⏱️ 开通时间", text: "账号开通后多久能用？" },
  { label: "📦 如何退款", text: "如果我不满意，怎么申请退款？" },
  { label: "🔧 使用教程", text: "能给我一个使用教程吗？" },
  { label: "🤔 最低档", text: "那最低一档的免费版有什么限制？" },
  { label: "⚠️ 超范围", text: "帮我订一张明天去北京的机票" },
];
